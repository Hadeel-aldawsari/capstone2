...
//    @GetMapping("/offers/{customRequestId}")
//    public List<ProviderOffer> getOffersForRequest(@PathVariable Integer customRequestId) {
//        return customRequestService.getOffersForRequest(customRequestId);
//    }
